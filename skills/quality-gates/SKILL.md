...
- The task is about opencode plugin hooks, not project git hooks
...
`@build` or `@fixer`. The orchestrator owns discovery, verification, and
reporting.
...
Delegate the implementation work to `@build` or `@fixer`:
